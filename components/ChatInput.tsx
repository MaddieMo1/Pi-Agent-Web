...
const TOOL_PRESET_LABELS: Record<"off" | "default" | "full", string> = {
  off: "关闭",
  default: "默认",
  full: "全部",
};
const THINKING_LEVELS = ["auto", "off", "minimal", "low", "medium", "high", "xhigh"] as const;
const THINKING_LEVEL_LABELS: Record<typeof THINKING_LEVELS[number], string> = {
  auto: "自动",
  off: "关闭",
  minimal: "最少",
  low: "低",
              ...
              <div ref={thinkingDropdownRef} style={{ position: "relative" }}>
                ...
                >
                  ...
                  <span>{(() => {
                    ...
                    if (lvl === "auto" || !thinkingLevelMap) return THINKING_LEVEL_LABELS[lvl];
                    const mapped = thinkingLevelMap[lvl];
                    return mapped != null ? mapped : THINKING_LEVEL_LABELS[lvl];
                  })()}</span>
                </button>
                {thinkingDropdownOpen && (
                  <div style={{
                    ...
                    {THINKING_LEVELS.filter((lvl) => {
                      ...
                      const displayLabel = (mappedVal != null && mappedVal !== lvl) ? mappedVal : THINKING_LEVEL_LABELS[lvl];
              ...
              <div ref={toolDropdownRef} style={{ position: "relative" }}>
                ...
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <span>{TOOL_PRESET_LABELS[(Object.entries(TOOL_PRESET_MAP).find(([, v]) => v === (toolPreset ?? "default"))?.[0] ?? "default") as "off" | "default" | "full"]}</span>
                </button>
                {toolDropdownOpen && (
                  <div style={{
                    position: "absolute", bottom: "calc(100% + 6px)", right: 0,
